...
<div class="signup-form">
    <form action="home.php" method="post" enctype="multipart/form-data">
		...
		<p class="hint-text"><br><b>Full Name: </b><?php echo $_SESSION["First_Name"] ?> <?php echo $_SESSION["Last_Name"] ?></p> <br>
        <div class="text-center">Want to Leave the Page? <br><a class="btn btn-info btn-sm" href="logout.php">Logout</a></div>
    </form>
